...
c      implicit none
      ...
      open (unit=20,file='hmmodel-delay.dat')
      k=0
      do while(k.lt.98)
         k=k+1
         print*,k
...
*     Generate two velocities from polar coordinates S & THETA.
 ...
 5       x(l)=m
      ...
      call pgbegin (0,'plot-q.eps/vcps',0,0) 
!     PLOT Gamma vs z
      call pgslw (2)         
...
!     labels
      ...
      call pgsci(40)
      call pgsch (0.7)
      call PGPTXT(60.,-1.6,0.,0.,'LIGO-Virgo')
      call pgsci(1)
      call PGPTXT(40.,.7,0.,0.,'w/out hierarchical mergers')
      call pgsci(4)
      call PGPTXT(40.,.2,0.,0.,'with hierarchical mergers')
...
!     without HMs      
      open (unit=20,file='mmodel-delay.dat')
      k=0
      do while(k.lt.98)
         k=k+1
         print*,k
